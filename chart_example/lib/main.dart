...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildButton({
    ...
    if (isActive) {
      bgColor = Theme.of(context).primaryColor.withAlpha(75);
      txtColor = Theme.of(context).primaryColor;
    } else {
      bgColor = Colors.transparent;
      txtColor = Theme.of(context).textTheme.bodyMedium?.color?.withAlpha(200);
    }
    return InkWell(
      onTap: () {
        onPress();
